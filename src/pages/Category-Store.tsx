        ...
        <IonPage>
            ...
            {/* <IonHeader>
                <IonToolbar className="new-background-color">
                    <IonTitle>Category Store</IonTitle>
                </IonToolbar>
            </IonHeader> */}
                    ...
                    <IonContent>
                        <IonGrid className="green-box">
                            ...
                            <IonRow>
                                ...
                                <IonCol size="2">
                                    <IonButton routerLink="/location-manual" className="btn-ganti" fill="outline">Ganti</IonButton>
...
Skincare</div>
                            ...
                            <IonRow>
                                <IonCol size="12">
                                    <IonItem lines="none" onClick={openOverlay} className="action-sheets-basic-page">
                                    ...
                                    <IonItem lines="none" onClick={openOverlay}>
                                        <IonThumbnail className="list-thumbnail" slot="start">
